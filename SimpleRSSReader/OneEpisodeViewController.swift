...
class OneEpisodeViewController: UITableViewController {
	...
	@IBOutlet weak var episodeContent: UIWebView!
    override func viewDidLoad() {
		...
		episodeContent.loadHTMLString((currentEpisode?.description)!, baseURL: nil)
